export const PIN_LIST = { role: 'plugin', module: 'dal-actions-list', schema: '*' };
export const PIN_TREE = { role: 'plugin', module: 'dal-actions-tree', schema: '*' };

export const PIN_LIST_FIND_ONE = { ...PIN_LIST, action: 'find-one', criteria: '*' };
export const PIN_LIST_FIND_LIST = { ...PIN_LIST, action: 'find-list', criteria: '*' };
