...
function schemaValidate() {
  ...
  const schema = _joi2.default.number().integer();
  return (0, _applyValidators2.default)(options, schema, [_setDefault2.default, _setRequired2.default, (0, _setMinMax2.default)({ min: _constants.MIN_SMALLINT, max: _constants.MAX_SMALLINT })]);
}
