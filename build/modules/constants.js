...
const PIN_LIST = exports.PIN_LIST = { role: 'plugin', module: 'dal-actions-list', schema: '*' };
const PIN_TREE = exports.PIN_TREE = { role: 'plugin', module: 'dal-actions-tree', schema: '*' };

const PIN_LIST_FIND_ONE = exports.PIN_LIST_FIND_ONE = _extends({}, PIN_LIST, { action: 'find-one', criteria: '*' });
const PIN_LIST_FIND_LIST = exports.PIN_LIST_FIND_LIST = _extends({}, PIN_LIST, { action: 'find-list', criteria: '*' });
